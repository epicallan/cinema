			...
			<ul class="individual-movie-slider clearfix">
				...
				<li class="movie-info">
					<ul>
						...
						<li class="buttons">
							<ul>
								<li class="schedule"><a href="#"><span></span>buy ticket</a></li>
						...
						<?php
							...
							if(!empty($coming_soon_src)):
								foreach ($coming_soon_src as $key=>$src):
										echo"<li index=\"$key\" id=\"$coming_soon_ids[$key]\" class='slides myslide$key' ><img src=\"$src\" class=\"$coming_soon[$key]\"  /></li>";
									endforeach; 
								endif;
							?>
						</ul>
